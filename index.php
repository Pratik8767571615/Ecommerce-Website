...
<head>
  ...
  <title>ESHOP - Shop your footware</title>
...
<body id="top">
  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <a href="#" class="logo">
        <img src="./assets/images/logo2.png" width="160" height="50" alt="Eshop logo">
      </a>
      ...
      <nav class="navbar" data-navbar>
        ...
        <a href="#" class="logo">
          <img src="./assets/images/logo2.png" width="190" height="50" alt="Eshop logo">
        </a>
            ...
            <li class="product-item">
              <div class="product-card" tabindex="0">
                ...
                <div class="card-content">
                  ...
                  <data class="card-price" value="180.85">Rs 14,994</data>
            ...
            <li class="product-item">
              <div class="product-card" tabindex="0">
                ...
                <div class="card-content">
                  ...
                  <data class="card-price" value="190.85">Rs 15,000</data>
            ...
            <li class="product-item">
              <div class="product-card" tabindex="0">
                ...
                <div class="card-content">
                  ...
                  <data class="card-price" value="160.85">Rs 13,000</data>
            ...
            <li class="product-item">
              <div class="product-card" tabindex="0">
                ...
                <div class="card-content">
                  ...
                  <data class="card-price" value="170.85">Rs 14,000 </data>
            ...
            <li class="product-item">
              <div class="product-card" tabindex="0">
                ...
                <div class="card-content">
                  ...
                  <data class="card-price" value="120.85">Rs 12,000</data>
            ...
            <li class="product-item">
              <div class="product-card" tabindex="0">
                ...
                <div class="card-content">
                  ...
                  <data class="card-price" value="100.85">Rs 8000</data>
            ...
            <li class="product-item">
              <div class="product-card" tabindex="0">
                ...
                <div class="card-content">
                  ...
                  <data class="card-price" value="120.85">Rs 9000</data>
            ...
            <li class="product-item">
              <div class="product-card" tabindex="0">
                ...
                <div class="card-content">
                  ...
                  <data class="card-price" value="100.85">Rs 5000</data>
              ...
              <li class="product-item">
                <div class="product-card" tabindex="0">
                  ...
                  <div class="card-content">
                    ...
                    <data class="card-price" value="180.85">Rs 14,000</data>
              ...
              <li class="product-item">
                <div class="product-card" tabindex="0">
                  ...
                  <div class="card-content">
                    ...
                    <data class="card-price" value="190.85">Rs 16,000</data>
              ...
              <li class="product-item">
                <div class="product-card" tabindex="0">
                  ...
                  <div class="card-content">
                    ...
                    <data class="card-price" value="160.85">Rs 10,000</data>
              ...
              <li class="product-item">
                <div class="product-card" tabindex="0">
                  ...
                  <div class="card-content">
                    ...
                    <data class="card-price" value="170.85">Rs 12,500 </data>
            ...
            <li class="service-item">
              <div class="service-card">
                ...
                <div>
                  ...
                  <p class="card-text">
                    All orders over <span>Rs 1200</span>
                  </p>
                </div>
            ...
            <li>
              <address class="footer-link">
                ...
                <span class="footer-link-text">
                  2751 S Shivaji chowk Rd, Hinjawadi, Pune, Maharashtra
                </span>
              </address>
            </li>

            <li>
              <a href="tel:+91 8767571615" class="footer-link">
                <ion-icon name="call"></ion-icon>

                <span class="footer-link-text">8767571615</span>
              </a>
            </li>

            <li>
              <a href="mailto:pratiksuryawanshi540@gmail.com" class="footer-link">
                <ion-icon name="mail"></ion-icon>

                <span class="footer-link-text">pratiksuryawanshi540@gmail.com</span>
              </a>
            </li>
